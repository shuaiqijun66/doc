...
![](../../Images/Pasted%20image%2020241129222659.png)
...
![](../../Images/Pasted%20image%2020241129232741.png)
...
3. vlan内arp代理：端口隔离
```
![](../../Images/Pasted%20image%2020241201142757.png)
...
![](../../Images/Pasted%20image%2020241203101640.png)
...
interface GigabitEthernet0/0/3
 ...
 port-isolate enable group 1
```
![](../../Images/Pasted%20image%2020241203101730.png)
![](../../Images/Pasted%20image%2020241203102002.png)
...
```
![](../../Images/Pasted%20image%2020241203142339.png)

当前端口设置成边缘端口后，如果收到BPDU报文，交换机会自动将边缘端口设置为非边缘端口。
![](../../Images/Pasted%20image%2020241203142409.png)
### 2.7 修改桥优先级
```
...
更改cost值
```
![](../../Images/Pasted%20image%2020241203142551.png)
![](../../Images/Pasted%20image%2020241203142558.png)
### 2.8 RSTP

```

```
![](../../Images/Pasted%20image%2020241203143823.png)
```shell
...
注意：每个实例使用独立的RSTP算法
```
![](../../Images/Pasted%20image%2020241203144119.png)
![](../../Images/1733208118349.jpg)
### 2.9 RSTP改进
![](../../Images/Pasted%20image%2020241204192943.png)
![](../../Images/Pasted%20image%2020241204194240.png)
![](../../Images/Pasted%20image%2020241204194552.png)
![](../../Images/Pasted%20image%2020241204194304.png)
![](../../Images/Pasted%20image%2020241204195818.png)
![](../../Images/Pasted%20image%2020241204195843.png)
![](../../Images/Pasted%20image%2020241204200232.png)
![](../../Images/Pasted%20image%2020241204201248.png)
![](../../Images/Pasted%20image%2020241204201700.png)
### 2.10 PA机制详解
![](../../Images/Pasted%20image%2020241204205437.png)

![](../../Images/Pasted%20image%2020241204205242.png)
![](../../Images/Pasted%20image%2020241204205746.png)
![](../../Images/Pasted%20image%2020241204210752.png)
### 2.11 PA机制实验
![](../../Images/Pasted%20image%2020241204212432.png)
![](../../Images/Pasted%20image%2020241204212506.png)
### 2.12 拓扑变更机制
![](../../Images/Pasted%20image%2020241204212845.png)
![](../../Images/Pasted%20image%2020241204214506.png)
### 2.13 保护功能
![](../../Images/Pasted%20image%2020241205091747.png)
...
![](../../Images/Pasted%20image%2020241205093140.png)

```shell
指定接口开启根保护功能：接口下 stp root-protection
```

![](../../Images/Pasted%20image%2020241205094942.png)
![](../../Images/Pasted%20image%2020241205100020.png)
...
![](../../Images/Pasted%20image%2020241205101300.png)
...
```
![](../../Images/Pasted%20image%2020241211094822.png)
...
```
### 2.15 MST Region
![](../../Images/Pasted%20image%2020241213101753.png)
### 2.16 MST Instance
![](../../Images/Pasted%20image%2020241213102238.png)
### 2.17 CST
![](../../Images/Pasted%20image%2020241213102952.png)
### 2.18 IST
![](../../Images/Pasted%20image%2020241213103422.png)
### 2.19 CIST
![](../../Images/Pasted%20image%2020241213103859.png)
### 2.20 SST
![](../../Images/Pasted%20image%2020241213104124.png)
### 2.21 总根、域根和主桥
![](../../Images/Pasted%20image%2020241213161643.png)
```shell
总根(CISTRoot)
	是CIST的根桥，如图中SW1。
...
![](../../Images/Pasted%20image%2020241214200001.png)

![](../../Images/Pasted%20image%2020241214194456.png)
### 2.22 MSTP拓扑计算
![](../../Images/Pasted%20image%2020241215084128.png)
...
![](../../Images/Pasted%20image%2020241215100552.png)
![](../../Images/Pasted%20image%2020241215101629.png)
![](../../Images/Pasted%20image%2020241215101708.png)
![](../../Images/Pasted%20image%2020241215101558.png)
### 2.23 MSTP端口角色和端口状态
![](../../Images/Pasted%20image%2020241215101816.png)
![](../../Images/Pasted%20image%2020241215102040.png)
![](../../Images/Pasted%20image%2020241215102428.png)
![](../../Images/Pasted%20image%2020241215102446.png)
### 2.24 MSTP报文
![](../../Images/Pasted%20image%2020241215195814.png)
...
![](../../Images/Pasted%20image%2020241223090352.png)
...
![](../../Images/Pasted%20image%2020241223165415.png)
...
**图RRPP环工作示意图**
![](../../Images/Pasted%20image%2020241223165743.png)
...
- 配置RRPP保护VLAN列表需要注意以下事项：
    ...
    5*24680=- 实/579*24`例和VLAN映射关系发生变化时，RRPP域的保护VLAN随之变化。
...
```
#### 3.1.15 RRPP单实例相交环配置举例
![](../../Images/Pasted%20image%2020241224101204.png)
![](../../Images/Pasted%20image%2020241224124245.png)
```shell
#SW4
#
vlan batch 2 to 11
...
rrpp domain 1
 control-vlan 10
 *7-=3579-4680=`-135an reference-instance 1
...
tEthernet0/0/2 level 0
 ring 1 enable
#
-13570=interface Giga/10=*3579246-`bitEthernet0/0/1
 port link-type trunk
 undo port trunk allow-pass vlan 1
 port trunk allow-pass vlan 2 to 11
 stp disable
...
interface GigabitEthernet0/0/2
 ...
 stp disable
```
#### 3.1.16 RRPP多实例相交环配置举例
![](../../Images/Pasted%20image%2020241224192846.png)

如图所示，采用环网结构时，为了提高对网络的利用率，希望空闲链路也承担数据流量的转发，不同VLAN数据按照不同路径进行转发，实现业务流量的负载分担。

24680/-579-`46
![](../../Images/截屏2024-12-24%2020.15.38.png)
...
# 配置UPEA为域2环1的传输节点，并指定主、副接口。rrpp domain 2
...
Secondary port : GigabitEthernet0/0/1               Port status: BLOCKED
```
#### 3.1.17 RRPP多实例相切环配置举例
![](../../Images/Pasted%20image%2020241225145120.png)

如图所示，采用环网结构时，为了提高对网络的利用率，希望空闲链路也承担数据流量的转发，不同VLAN数据按照不同路径进行转发，实现业务流量的负载分担。

**配置拓扑图**
![](../../Images/Pasted%20image%2020241225145452.png)
...
3. 配置设备上将要加入RRPP的各接口，使其可以通过RRPP环上需要通过的VLAN数据，并去使能与RRPP相冲突的功能（例如STP功能）。  
4. 在各RRPP域中/*-167890/-=`-60-=`护VLAN并创建RRPP环。
...
*45=6789-=`678in-region1] ri6-` enable
[UPED-rrpp-domain-region1] quit
...
Protected VLAN : Reference Instance 3
Hello Timer    : 1 sec(default is 1 sec)  Fail Timer : 6 sec(default is 6 sec)
 Ring/*--=90`/-g   Node  Primary/Common           Secondary/Edge           Is
 ID    Level  Mode  Port                     Port                     Enabled
...
![](../../Images/Pasted%20image%2020241225162641.png)
...
![](../../Images/Pasted%20image%2020241225163104.png)

如[图](Pasted%20image%2020241225163104.png)所示，LSW1～LSW5组成了双归链路接入上级二层网络组网，位于上级二层网络的两台边缘设备LSW1和LSW5之间不是直连的方式，这种组网方式称之为开放环接入。这样的接入方式在整个网络中将引入新的环路。为了消除网络中冗余环路，有效地保证链路连通性，需要启动环路保护机制。[图](../../Images/Pasted%20image%2020241225163104.png)所示是一个典型的启动SEP协议的开放环组网图，以下结合该图介绍SEP的基本概念。
...
![](../../Images/Pasted%20image%2020241225191707.png)

如图所示，LSW1～LSW5组成半环网络接入上级二层网络，位于上级二层网络的两台边缘设备LSW1和LSW5之间不是直连的方式，这种组网方式称之为开放环接入。此组网位于接入层，完成单播业务及组播业务的二层透传功能。通过在接入层运行SEP协议，实现接入环的冗余保护倒换、拓290-=90-=``扑查看。

开放环组网的特点是环上的两个边缘端口部署在两个边缘设备上。

##### 3.2.7.2 封闭环组网应用

![](../../Images/Pasted%20image%2020241225191833.png)
...
![](../../Images/Pasted%20image%2020241225191950.png)
...
![](../../Images/Pasted%20image%2020241225194410.png)
...
![](../../Images/Pasted%20image%2020241225194506.png)
...
如果接入层拓扑发生变化，SEP段内会发送FLUSH-FDB报文通知本SEP段内其他节点进行MAC转发表和ARP表刷新。SEP段上的边缘设备PE1和PE2/*34560-=567/89*-12`会发送TC通告，通知汇聚层，SEP段的拓扑发生变化。

混合环组网的特点是需要在运行SEP协议的网络中的边缘设备PE1和PE2上部署SEP向RRPP拓扑变化通告。

##### 3.2.7.6 SEP多实例应用

![](../../Images/Pasted%20image%2020241225194605.png)
...
![](../../Images/Pasted%20image%2020241225194717.png)
...
![](../../Images/Pasted%20image%2020241225194824.png)
...
![](../../Images/Pasted%20image%2020241225195029.png)

*配置拓扑图*

![](../../Images/截屏2024-12-26%2014.09.47.png)
...
567[LSW1-GigabitEthernet1/0/3] stp dis5812-890`672=4/*-18903-=456/-=`123
...
SEP segment 1
356`345-=`1234/5243452=`145896`7568    Port Name        Port Role       Port Status`-90-=789678909-`2890-346789=`213462
...
![](../../Images/Pasted%20image%2020241226142524.png)
...
*配置拓扑图*
![](../../Images/Pasted%20image%2020241226200711.png)
...
![](../../Images/Pasted%20image%2020241230205040.png)
...
*拓扑配置图*
![](../../Images/Pasted%20image%2020250104215831.png)
...
```
### 4.2 堆叠的建立
![](../../Images/Pasted%20image%2020241221130111.png)
...
![](../../Images/Pasted%20image%2020250109140855.png)
...
![](../../Images/Pasted%20image%2020250109140946.png)

### 1.4 PPP建链过程
![](../../Images/Pasted%20image%2020250109141107.png)
...
![](../../Images/Pasted%20image%2020250109141418.png)
...
![](../../Images/Pasted%20image%2020250109141457.png)
...
![](../../Images/Pasted%20image%2020250110141019.png)
```shell
AR1 PAP
#
aaa 
...
![](../../Images/Pasted%20image%2020250110141444.png)
### 1.7 NCP
...
## 1 IPV6产生的背景
## 2 IPV6报文抓取
![](../../Images/b8f41df2-f021-46d7-86f3-156bed88cc8e.png)

![](../../Images/Pasted%20image%2020260308150701.png)
